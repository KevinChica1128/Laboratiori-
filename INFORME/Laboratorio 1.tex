...
\begin{figure}[h!]
  \centering
  \includegraphics[scale=0.25]{FigurasUV/G4.pdf}
...
\begin{figure}[h!]
  \centering
  \includegraphics[scale=0.25]{FigurasUV/G5.pdf}
...
\begin{figure}[h!]
  \centering
  \includegraphics[scale=0.25]{FigurasUV/G1.pdf}
...
\begin{figure}[h!]
  \centering
  \includegraphics[scale=0.25]{FigurasUV/G2.pdf}
...
\begin{figure}[h!]
  \centering
  \includegraphics[scale=0.25]{FigurasUV/G3.pdf}
...
\begin{figure}[h!]
  \centering
  \includegraphics[scale=0.25]{FigurasUV/G6.pdf}
  \caption{Gráfico de la proyección de la matriz de datos estandarizada con tres componentes principales}\label{figura1}
\end{figure}
\end{itemize}

\section{Conclusiones}
~\\Teniendo en cuenta los gráficos realizados con la matriz de datos estandarizados, podemos decir que hay plantas similares a otras en cuento a las mediciones de las variables, según la figura 5 podemos apreciar que las plantas 9, 2, 3 y también las plantas 6 y 4 tienen características similares.
